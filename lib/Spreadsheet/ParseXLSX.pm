...
sub _parse_workbook {
    my ( $self, $zip, $workbook, $formatter ) = @_;
...
sub _parse_shared_strings {
    my ( $self, $strings, $theme_colors ) = @_;
...
sub _parse_xml {
    my ( $self, $zip, $subfile, $map_xmlns ) = @_;
...
sub _color {
    my ( $self, $colors, $color_node, $fill ) = @_;
