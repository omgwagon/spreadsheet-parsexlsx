...
sub decrypt {
    my ( $self, $encryptedValue, $blockKey ) = @_;
...
sub decryptFile {
    my ( $self, $inFile, $outFile, $bufferLength, $key, $fileSize ) = @_;
...
sub verifyPassword {
    my ( $self, $encryptedVerifier, $encryptedVerifierHash ) = @_;
